/**********************************************************************************************************************
 * Conway's Game of Life on GPU using CUDA (http://marekfiser.cz)                                                     *
 * Copyright (c) 2014 Marek Fiser <code[]marekfiser cz>                                                               *
 * Published under the MIT License, see LICENSE.txt file or http://opensource.org/licenses/MIT for full license terms.*
 **********************************************************************************************************************/
